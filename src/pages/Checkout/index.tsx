                ...
                {payWithCard ? (
                  <>
                    ...
                    <S.Row marginTop="24px;">
                      ...
                      <S.InputGroup maxWidth="123px">
                        <label htmlFor="expiresYear">Ano do expiração</label>
                        <input
                          type="text"
                          id="expiresYear"
                          name="expiresYear"
                  ...
                  <p>
                    ...
                    Laudantium totam, eum eius ut nesciunt modi quod
                    voluptatibus! Quos nihil rerum voluptate animi? Ea pariatur
                    assumenda laboriosam quibusdam beatae porro ab.
                  </p>
                )}
              </div>
            </>
